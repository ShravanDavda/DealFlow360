...
CREATE TABLE IF NOT EXISTS products (
    ...
    cgst_percent NUMERIC(5, 2) NOT NULL DEFAULT 0 CHECK (cgst_percent >= 0 AND cgst_percent <= 100),
    sgst_percent NUMERIC(5, 2) NOT NULL DEFAULT 0 CHECK (sgst_percent >= 0 AND sgst_percent <= 100),
