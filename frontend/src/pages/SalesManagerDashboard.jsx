    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 mx-auto w-full max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div><h1 className="text-2xl font-bold tracking-tight text-slate-900">Sales Manager Dashboard</h1><p className="mt-1 text-sm text-slate-600">Monitor team quotations, approvals, deal health and sales performance.</p></div>
